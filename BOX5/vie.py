...
def send_heartbeat(ip="127.0.0.4", port=9998, nom_boite="BOX5", interval=10):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--nom", default="BOX5", help="Nom de la boîte")
    parser.add_argument("--ip", default="127.0.0.4", help="Adresse IP cible")
    parser.add_argument("--port", type=int, default=9998, help="Port UDP cible")
